    ...
    echo '
        <script>
            alert("Usuario almacenado exitosamente");
             window.location = "http://localhost/Renueva-Hogar-practica/register.php";
        </script>
    ';
}
...
<a href="http://localhost/Renueva-Hogar-practica/register.php">Volver al formulario</a>
<a href="http://localhost/Renueva-Hogar-practica/index.php">Volver a la Pagina Principal</a>
<style>
